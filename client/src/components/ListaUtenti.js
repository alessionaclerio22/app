      ...
      <>
        {this.props.lista === "listamedici" &&
          this.props.pagina === "paginapaziente" && (
            <Tab.Container defaultActiveKey="#0">
              <Row className="custom-row" style={{ marginTop: "3vh" }}>
                <Col>
                  <ListGroup>
                                  ...
                                  <Modal.Header closeButton>
                                    <Col sm="9">
                                      <Modal.Title id="contained-modal-title-vcenter">
                                        Sei sicuro di volere rimuovere il
                                        medico?
                                      </Modal.Title>
                                    </Col>
                                    <Col>
            ...
            <Table striped bordered hover>
              <thead>
                <tr>
                  ...
                  {this.props.pagina !== "paginainfermiere" && <th>Rimuovi</th>}
                </tr>
              </thead>
              <tbody>
                      ...
                      <Button
                        ...
                        onClick={(event) =>
                          (window.location.href =
                            "/medici/" + this.props.id + "/pazienti/" + p.pid)
                        }
                      >
                    ...
                    <Col>
                      <Button
                        ...
                        onClick={() => {
                          ...
                          this.props.deletePaz(this.state.index);
                          this.closeModal();
                        }}
                      >
                        Conferma
        ...
        {this.props.lista === "listainfermieri" &&
          this.props.pagina === "paginamedico" && (
            <Tab.Container defaultActiveKey="#0">
              <Row className="custom-row" style={{ marginTop: "2rem" }}>
                <Col>
                  <ListGroup>
                  ...
                  <Tab.Content>
                    ...
                    >
                      <Modal.Header closeButton>
                        <Col sm="9">
                          <Modal.Title id="contained-modal-title-vcenter">
                            Sei sicuro di volere rimuovere l'infermiere?
                          </Modal.Title>
                        </Col>
                        <Col>
                          <Button
                            ...
                            onClick={() => {
                              ...
                              this.closeModalInf();
                              this.props.deleteInf(this.state.index);
                            }}
                          >
                            Conferma
                          </Button>
